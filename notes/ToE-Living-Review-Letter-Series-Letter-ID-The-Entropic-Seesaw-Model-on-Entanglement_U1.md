...
A Complete Entropic Theory of Quantum Entanglement, the Attosecond Formation-Time Evidence, and the Resolution of Einstein’s EPR Paradox and ER=EPR



John Onimisi Obidi (jonimisiobidi@gmail.com)
...
8.2 The ESSM Resolution 51

8.3 Why ESSM Does Not Reintroduce Hidden Variables 52

8.4 The No-Signaling Proof 53
...
1. The Entanglement Problem in Contemporary Physics
1.1 The Standard Quantum-Mechanical Account
...
1.3 The Need for an Ontological Theory of Entanglement
...
2. The Ontological Core of the Entropic Seesaw Model(ESSM)
2.1 The Entropic Field as Ontological Substrate
...
2.2 Entanglement as Shared Entropic Manifold
...
2.3 The Dual Geometry: Spatial Distance versus Entropic Distance
...
2.4 Symmetric and Antisymmetric Entropic Modes
...
2.5 The Entropic Distance Functional
...
3. The Mathematical Architecture — The ESSM Effective Action
3.1 The Two-Sector Entropic Action
...
3.2 The Full ESSM Effective Action in Symmetric-Antisymmetric Variables
...
3.3 The Bridge Order Parameter and Symmetry Breaking
...
3.4 The Coherence Strength Functional
...
3.5 The Equation of Motion for the Antisymmetric Mode
...
4. Formation Dynamics — The Entropic Genesis of Entanglement
4.1 The Formation Drive Equation
...
4.3 The Formation Time and Threshold Crossing
...
4.4 The Entropic Time-Limit (ETL) Bounds
...
4.5 The Entropic Formation Functional
...
5. Persistence, Propagation, and the Seesaw Equilibrium
5.1 The Persistence Law
...
5.2 The Two-Layer Architecture Applied to Entanglement
...
5.3 The Entropic Seesaw Equilibrium Condition (TESEC)
...
6. Decoherence, Measurement, and the Seesaw Collapse Threshold
...
6.2 The Decoherence Rate Decomposition
...
6.3 The Entropic Seesaw Collapse Mechanism (TESCM)
...
6.4 The Seesaw-Collapse Threshold from Measurement Loading
...
6.5 Entropic Bookkeeping: The Second Law in the Coherent Sector
...
7. The Attosecond Entanglement Formation Time — Empirical Anchors for ESSM
7.1 The Experimental Landscape
...
7.2 ESSM Interpretation of the Attosecond Results
...
7.3 ESSM Predictions versus Standard Interpretation
...
Entanglement arises as soon as the interaction Hamiltonian acts; no intrinsic formation time

Finite threshold-crossing time t_c, governed by formation drive, decoherence rate, and entropic time-limit bounds

Persistence mechanism

Unitary evolution preserves the state vector

Structural persistence of the shared entropic manifold M_AB; entropic distance d_E remains near zero

Decoherence source

Environment-induced suppression of off-diagonal density matrix elements

Growth of the antisymmetric mode S₋ under environmental torque/ET; closure of the entropic mass gap

Bell correlations

Non-factorizability of the bipartite state vector

Structural unity of the shared entropic manifold; correlations are local in entropic geometry

Measurement role

Projection postulate; instantaneous collapse

Asymmetric entropic torque that tips the seesaw when exceeding the restoring force; threshold transition, not discontinuity

Channel dependence

Entanglement depends on the coupling Hamiltonian; no formation-time channel dependence

t_c, τ_coh, and γ_d are independently variable and channel-specific




7.4 The Experimental Anchors Table
...
Photoionization time delays probe coherence and entanglement

Formation time t_c; coherence dynamics; entropic reorganization timescale
...
Emission direction control of entangled photoelectrons

Channel dependence of entanglement; controllability of seesaw formation

Stenquist and Dahlström [29]

2025

Atomic (theoretical)

Time-symmetry alters entanglement degree

Formation drive r_f depends on pulse symmetry properties
...
Ionic coupling effects on attosecond time delays through entanglement

Channel-resolved formation times; multichannel ESSM predictions
...
Ion–photoelectron entanglement affects electronic coherence; controllable degree

Formation-persistence distinction; seesaw equilibrium; controllable Γ_AB

Mao et al. [32]

2026

Multiphoton (experimental)

Coherent control of electron-ion entanglement

Extension of ESSM to multiphoton formation channels
...
8. Einstein's EPR Paradox Dissolved — Entropic Distance versus Spatial Distance
8.1 The EPR Argument Reconstructed
...
8.3 Why ESSM Does Not Reintroduce Hidden Variables
...
9. ER=EPR Reinterpreted — The Entropic Bridge Completion
9.1 The Maldacena-Susskind Conjecture (MSC) and Its Scope
...
9.3 The Geometric Shadow Interpretation
...
9.4 ESSM as Thermodynamic Completion of ER=EPR
...
10. Testable Predictions, Experimental Protocols, and the ESSM Research Program
10.1 The Asymmetric Entropy-Injection Protocol
...
10.2 Channel-Resolved Formation Time Measurements
...
10.3 The Coherence-Lifetime Scaling Law
...
10.4 Comparative Predictions Table
...
Formation time dependence on ionic channel

Formation is instantaneous (interaction-dependent but not channel-resolved in formation time)

t_c varies by ionic channel; scales with r_f and Γ*

Coherence decay under asymmetric noise

Exponential decay; rate depends on coupling to noise

Exponential decay with rate given by equation (24); specific asymmetric-injection dependence

Coherence lifetime versus initial coherence

Not specifically predicted

τ_coh ∝ Γ_AB(t_s) / γ_d (linear in initial coherence)

Formation-persistence distinction

Not distinguished: entanglement arises and persists by unitary evolution

Formation and persistence are dynamically distinct with independent timescales and different parametric dependencies

Pulse-symmetry effect on entanglement degree

Entanglement depends on pulse parameters through the Hamiltonian

Time-symmetry of the pulse affects r_f and hence t_c; consistent with Stenquist-Dahlström results [29]




10.5 The ESSM Experimental Roadmap
...
11. Open Mathematical Frontiers and Concluding Assessment
11.1 Open Mathematical Tasks
...
11.2 Limitations, Constraints, and Strategic Directions
...
11.3 Assessment and Significance
...
[37] H. M. Wiseman, S. J. Jones, and A. C. Doherty, "Steering, Entanglement, Nonlocality, and the Einstein-Podolsky-Rosen Paradox," Physical Review Letters 98, 140402 (2007).

[38] A. Aspect, J. Dalibard, and G. Roger, "Experimental Realization of Einstein-Podolsky-Rosen-Bohm Gedankenexperiment: A New Violation of Bell's Inequalities," Physical Review Letters 49, 1804–1807 (1982).
...
Correspondence & Foundational Texts [41]–[45]
...
© 2026 The Theory of Entropicity (ToE) Living Review Letters. Letter ID.
...
The Theory of Entropicity (ToE) Living Review Letters Series. Letter ID Page 0 of 29
