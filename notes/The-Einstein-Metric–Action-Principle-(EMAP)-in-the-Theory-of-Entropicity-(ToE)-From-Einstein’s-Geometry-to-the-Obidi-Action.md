...
This is the original Metric–Action Principle.
...
> why do we expect information geometry to become physical without one?

This is the conceptual breakthrough.

Information geometry has:

- Fisher–Rao metric  
- α‑connections  
- statistical curvature  

But it has no action, therefore:
...
> Give information geometry an action, and it will become physical —  
> just like Einstein did for spacetime.

This is the Obidi Action.
...
“Geometry becomes physical only when governed by an action.”
...
This is not analogy.  
This is the structural backbone of the Theory of Entropicity.
...
- Obidi activates information geometry through an action.  
- The dynamics produce spacetime as a solution, not an assumption.
